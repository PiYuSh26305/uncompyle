...
#print(len(feyzo))
intro="""
        Always enter a number before entering dns
...
\33[1;44m
Select portal type = \33[0m\33[31m\33[1;37;41m"""
...
if "1"=="1":
 	say=0
 	dsy=""
 	dsy="\n       \33[1;4;94;47m 0=⫸ Random MAC (No combo needed) \33[0m\n"
 	dir='/sdcard/combo/'
 	file=len(feyzo)
...
"""+dsy+"""
\33[33mFound """ +str(say)+""" files in your combo folder!
	""")
 	dsyno=str(input("\33[31mEnter number of combo = \33[0m"))
 	say=0
...
\33[1;96mSelect number of bots!
\33[0m
\33[1;33mMust be between 1 and 25!\33[0m
...
What do you want to show in the results?
   ...
   1=⫸ Channels only
   2=⫸ Everything (LIVE-VOD-SERIES)    

\33[1mEnter number of choice = """)
if kanalkata=="":
	kanalkata="0"
...
Dosyab="/sdcard/🄰🅅🄴🄽🄶🄴🅁🅂_" +panel.replace(":","_").replace('/','') +".txt"
say=1
def yax(hits):
    dosya=open(Dosyab,'a+') 
    dosya.write(hits)
